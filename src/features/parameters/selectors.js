...
/**
 * Returns whether the parameter viewer dialog is supposed to be open.
 */
export function isParameterViewerDialogOpen(state) {
  return Boolean(state.parameters.viewerDialog?.open);
}
