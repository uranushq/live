        ...
        <div style={{ position: 'relative', width: '100%', pointerEvents: 'auto' }}>
          {panel === 'status' && (
            <div style={{ ...popoverStyle, left: 0, width: 320 }}>
              <div style={{ ...sectionLabelStyle, marginBottom: 10 }}>시퀀스 정보</div>
              <div
                style={{
                  display: 'grid',
            ...
            >
              <Tooltip title={isPlaybackRunning ? '일시정지' : '재생'} placement="top">
                ...
                >
                  {isPlaybackRunning ? (
                    ...
                    <PlayArrow sx={{ fontSize: 18, color: 'inherit', ml: '1px' }} />
                  )}
                </button>
              </Tooltip>
              ...
              <button
                ...
                style={{
                  ...
                  border: `1px solid ${NEUTRAL_700}`,
                  background:
                    panel === 'status' ? 'rgba(103, 180, 255, 0.12)' : 'transparent',
                  cursor: 'pointer',
                  maxWidth: 220,
                }}
              >
                ...
                <KeyboardArrowUp sx={{ fontSize: 12, color: 'inherit', flexShrink: 0 }} />
              </button>
